...
export default ({
  ...
  heading = (
    <>
     Tenemos al mejor equipo de consultores<span tw="text-primary-500"></span> en el mercado.
    </>
  ),
  ...
  const defaultFeatures = [
    {
      ...
      description: "Contamos con el mejor equipo de consultores preparados para trabajar con tu empresa."
    },
    {
      Icon: MoneyIcon,
      title: "Asequible",
      description: "Servicio de primera con la mejor oferta del mercado, a la par del estándar actual."
    }
  ];
